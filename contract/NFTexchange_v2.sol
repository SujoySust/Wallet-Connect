...
contract NFTexchange {
    ...
    string private constant SELL_TYPE = "SellOrder(string _sellId,uint _startsAt,uint _expiresAt,address _nftContract,uint256 _nftTokenId,address _paymentTokenContract,address _seller,uint256 _sellerAmount,uint256 _feeWithRoyalty,uint256 _totalAmount)";
    string private constant BUY_TYPE = "BuyOrder(string _buyId,uint _startsAt,uint _expiresAt,address _nftContract,uint256 _nftTokenId,address _paymentTokenContract,address _buyer,uint256 _sellerAmount,uint256 _feeWithRoyalty,uint256 _totalAmount)";
